                ...
                children: [
                  ...
                  Expanded(
                      ...
                      child: ListView(
                        ...
                        children: [
                          getSvgImage(image ?? "eur.svg",
                              height: FetchPixels.getPixelHeight(100),
                              width: FetchPixels.getPixelHeight(100)),
                          getVerSpace(FetchPixels.getPixelHeight(14)),
                          getCustomFont(
                              "\$${price ?? "56.55"}", 24, Colors.black, 1,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              getCustomFont("54.32 ${currency ?? 'EUR'}", 15,
                                  subtextColor, 1,
                                  fontWeight: FontWeight.w400)
                            ],
                          ),
                          getVerSpace(FetchPixels.getPixelHeight(14)),
                          getCustomFont("25 June, 2022", 15, subtextColor, 1,
                              fontWeight: FontWeight.w400,
                              textAlign: TextAlign.center),
                          getVerSpace(FetchPixels.getPixelHeight(30)),
                          Container(
